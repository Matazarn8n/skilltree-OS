...
description: "Générateur d'images de marque : produit des visuels cohérents avec ton identité à partir de tes références, prêts à décliner sur tous tes supports."
---

# Designer visuel de marque · fiche skill SkillTree

**Catégorie :** Marketing · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Générateur d'images de marque : produit des visuels cohérents avec ton identité à partir de tes références, prêts à décliner sur tous tes supports.
...
- « Lance le Designer visuel de marque »
- « Lance le Designer visuel de marque · [ton contexte précis ici] »

Ou juste : « Lance le Designer visuel de marque » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il garde la même identité visuelle d'un visuel à l'autre, sans dérive de style.
...
3. Sauvegarder la sortie dans `outputs/brand-visual-designer/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/brand-visual-designer/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/brand-visual-designer.md), texte entièrement réécrit, jamais copié.*
