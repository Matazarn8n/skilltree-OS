...
description: "Entretient ta bibliothèque de preuves et associe la bonne étude de cas au secteur et au problème de chaque prospect."
---

# Curateur d'études de cas · fiche skill SkillTree

**Catégorie :** Ventes · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Entretient ta bibliothèque de preuves et associe la bonne étude de cas au secteur et au problème de chaque prospect.

Une preuve générique ne convainc personne ; un prospect croit l'histoire de quelqu'un qui lui ressemble.
...
- « Lance le Curateur d'études de cas »
- « Lance le Curateur d'études de cas · [ton contexte précis ici] »

Ou juste : « Lance le Curateur d'études de cas » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il classe les preuves par problème résolu, pas par ordre chronologique.
...
3. Sauvegarder la sortie dans `outputs/case-study-curator/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/case-study-curator/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/case-study-curator.md), texte entièrement réécrit, jamais copié.*
