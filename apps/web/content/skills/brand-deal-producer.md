---
name: brand-deal-producer
description: "Gère toute la paperasse de production des contenus sponsorisés — celle qui fait traîner les deals pendant des semaines : brief créatif, calendrier de livraison, droits d'usage, facturation."
---

# Producteur de deals de marque · fiche skill SkillTree

**Catégorie :** Marketing · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Gère toute la paperasse de production des contenus sponsorisés — celle qui fait traîner les deals pendant des semaines : brief créatif, calendrier de livraison, droits d'usage, facturation.
...
- « Lance le Producteur de deals de marque »
- « Lance le Producteur de deals de marque · [ton contexte précis ici] »

Ou juste : « Lance le Producteur de deals de marque » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il transforme un deal signé en planning de production concret dès le lendemain.
...
3. Sauvegarder la sortie dans `outputs/brand-deal-producer/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/brand-deal-producer/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/brand-deal-producer.md), texte entièrement réécrit, jamais copié.*
