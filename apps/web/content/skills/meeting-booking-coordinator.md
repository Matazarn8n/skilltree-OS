---
name: meeting-booking-coordinator
description: "Transforme un « oui, parlons-en » en invitation calendrier avec le minimum d'allers-retours."
---

# Coordinateur de prise de rendez-vous · fiche skill SkillTree

**Catégorie :** Affaires · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Transforme un « oui, parlons-en » en invitation calendrier avec le minimum d'allers-retours.
...
- « Lance le Coordinateur de prise de rendez-vous »
- « Lance le Coordinateur de prise de rendez-vous · [ton contexte précis ici] »

Ou juste : « Lance le Coordinateur de prise de rendez-vous » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il compte chaque aller-retour en trop comme une occasion de perdre le prospect.
...
3. Sauvegarder la sortie dans `outputs/meeting-booking-coordinator/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/meeting-booking-coordinator/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/meeting-booking-coordinator.md), texte entièrement réécrit, jamais copié.*
