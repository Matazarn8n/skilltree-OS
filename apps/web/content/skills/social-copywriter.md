...
description: "Écrit la couche caption — le texte qui décide si un post transforme l'attention en action."
---

# Rédacteur social · fiche skill SkillTree

**Catégorie :** Marketing · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Écrit la couche caption — le texte qui décide si un post transforme l'attention en action.
...
- « Lance le Rédacteur social »
- « Lance le Rédacteur social · [ton contexte précis ici] »

Ou juste : « Lance le Rédacteur social » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il sait qu'une bonne accroche visuelle sans bonne légende ne convertit pas.
...
3. Sauvegarder la sortie dans `outputs/social-copywriter/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/social-copywriter/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/social-copywriter.md), texte entièrement réécrit, jamais copié.*
