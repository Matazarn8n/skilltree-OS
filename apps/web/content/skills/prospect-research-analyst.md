---
name: prospect-research-analyst
description: "Construit des rapports de renseignement profonds et actionnables sur les prospects cibles."
---

# Analyste de recherche de prospects · fiche skill SkillTree

**Catégorie :** Ventes · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Construit des rapports de renseignement profonds et actionnables sur les prospects cibles.
...
- « Lance le Analyste de recherche de prospects »
- « Lance le Analyste de recherche de prospects · [ton contexte précis ici] »

Ou juste : « Lance le Analyste de recherche de prospects » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il documente ce qui est actionnable, pas une liste de faits sans lien avec la vente.
...
3. Sauvegarder la sortie dans `outputs/prospect-research-analyst/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/prospect-research-analyst/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/prospect-research-analyst.md), texte entièrement réécrit, jamais copié.*
