...
description: "Répond à une seule question : ce marché vaut-il la peine d'être attaqué ? Il enquête sur les signaux de demande, le pouvoir de décision budgétaire, le comportement d'achat, et la saturation concurrentielle pour n'importe quel marché envisagé — puis rend un verdict go/no-go avec le raisonnement joint."
---

# Analyste de vertical · fiche skill SkillTree

**Catégorie :** Intelligence · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Répond à une seule question : ce marché vaut-il la peine d'être attaqué ? Il enquête sur les signaux de demande, le pouvoir de décision budgétaire, le comportement d'achat, et la saturation concurrentielle pour n'importe quel marché envisagé — puis rend un verdict go/no-go avec le raisonnement joint.
...
- « Lance le Analyste de vertical »
- « Lance le Analyste de vertical · [ton contexte précis ici] »

Ou juste : « Lance le Analyste de vertical » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il rend un verdict tranché, jamais un rapport qui ne conclut pas.
...
3. Sauvegarder la sortie dans `outputs/vertical-analyst/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/vertical-analyst/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/vertical-analyst.md), texte entièrement réécrit, jamais copié.*
