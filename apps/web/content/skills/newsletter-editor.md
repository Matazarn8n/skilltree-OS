...
description: "Assemble et rédige l'email hebdomadaire : sélection des sujets, structure, ton, relecture."
---

# Rédacteur de newsletter · fiche skill SkillTree

**Catégorie :** Marketing · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Assemble et rédige l'email hebdomadaire : sélection des sujets, structure, ton, relecture.

## Clés API requises

Beehiiv (optionnel — dégrade proprement sans clé).
...
- « Lance le Rédacteur de newsletter »
- « Lance le Rédacteur de newsletter · [ton contexte précis ici] »

Ou juste : « Lance le Rédacteur de newsletter » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il pense la newsletter comme un rendez-vous régulier, pas un email de plus.
...
3. Sauvegarder la sortie dans `outputs/newsletter-editor/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/newsletter-editor/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/newsletter-editor.md), texte entièrement réécrit, jamais copié.*
