...
description: "Prend une copie finalisée et une liste vérifiée et met la campagne en ligne — correctement, sans étape sautée : séquençage, warm-up, suivi des envois."
---

# Gestionnaire d'opérations de campagne · fiche skill SkillTree

**Catégorie :** Ventes · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Prend une copie finalisée et une liste vérifiée et met la campagne en ligne — correctement, sans étape sautée : séquençage, warm-up, suivi des envois.

## Clés API requises

Heyreach, Instantly (optionnel — dégrade proprement sans clé).
...
- « Lance le Gestionnaire d'opérations de campagne »
- « Lance le Gestionnaire d'opérations de campagne · [ton contexte précis ici] »

Ou juste : « Lance le Gestionnaire d'opérations de campagne » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il traite le lancement comme une checklist opérationnelle, pas comme un bouton à cliquer.
...
3. Sauvegarder la sortie dans `outputs/campaign-operations-manager/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/campaign-operations-manager/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/campaign-operations-manager.md), texte entièrement réécrit, jamais copié.*
