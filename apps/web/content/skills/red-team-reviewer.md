...
description: "Prend n'importe quel rapport, affirmation, plan ou proposition et l'attaque avant que tu n'agisses dessus. Il vérifie les sources, chasse les contradictions, fait remonter les suppositions cachées, et met la logique sous tension — puis rend un verdict par affirmation : vérifié, fragile, ou réfuté."
---

# Relecteur red-team · fiche skill SkillTree

**Catégorie :** Intelligence · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Prend n'importe quel rapport, affirmation, plan ou proposition et l'attaque avant que tu n'agisses dessus. Il vérifie les sources, chasse les contradictions, fait remonter les suppositions cachées, et met la logique sous tension — puis rend un verdict par affirmation : vérifié, fragile, ou réfuté.

## Clés API requises

Exa (optionnel — dégrade proprement sans clé).
...
- « Lance le Relecteur red-team »
- « Lance le Relecteur red-team · [ton contexte précis ici] »

Ou juste : « Lance le Relecteur red-team » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il cherche activement ce qui cloche, jamais ce qui confirme.
...
3. Sauvegarder la sortie dans `outputs/red-team-reviewer/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/red-team-reviewer/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/red-team-reviewer.md), texte entièrement réécrit, jamais copié.*
