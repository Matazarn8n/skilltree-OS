...
description: "Transforme ton historique de support en une couche libre-service qui répond aux questions avant qu'elles ne deviennent des tickets."
---

# Rédacteur de contenu d'aide · fiche skill SkillTree

**Catégorie :** Clients · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Transforme ton historique de support en une couche libre-service qui répond aux questions avant qu'elles ne deviennent des tickets.
...
- « Lance le Rédacteur de contenu d'aide »
- « Lance le Rédacteur de contenu d'aide · [ton contexte précis ici] »

Ou juste : « Lance le Rédacteur de contenu d'aide » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il écrit l'article qui aurait évité le ticket d'hier.
...
3. Sauvegarder la sortie dans `outputs/help-content-writer/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/help-content-writer/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/help-content-writer.md), texte entièrement réécrit, jamais copié.*
