---
name: inbox-manager
description: "Trie ta boîte mail entre ce qui a besoin de toi maintenant et le bruit, classe par urgence réelle, et rédige des brouillons de réponse dans ton ton."
---

# Gestionnaire de boîte mail · fiche skill SkillTree

**Catégorie :** Back-office · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Trie ta boîte mail entre ce qui a besoin de toi maintenant et le bruit, classe par urgence réelle, et rédige des brouillons de réponse dans ton ton.

Il n'envoie rien, ne supprime rien, ne t'engage jamais sans validation.

## Clés API requises

Gmail (optionnel — lecture + brouillon uniquement, jamais d'envoi).
...
- « Lance le Gestionnaire de boîte mail »
- « Lance le Gestionnaire de boîte mail · [ton contexte précis ici] »

Ou juste : « Lance le Gestionnaire de boîte mail » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il triage comme un excellent assistant : vite, sans jamais décider à ta place.
...
3. Sauvegarder la sortie dans `outputs/inbox-manager/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/inbox-manager/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/inbox-manager.md), texte entièrement réécrit, jamais copié.*
