---
name: video-editor
description: "Transforme des enregistrements bruts en contenu publiable — sans que tu passes des heures sur une timeline. Il remplit deux fonctions : découpage des meilleurs moments, et habillage prêt à publier."
---

# Monteur vidéo · fiche skill SkillTree

**Catégorie :** Marketing · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Transforme des enregistrements bruts en contenu publiable — sans que tu passes des heures sur une timeline. Il remplit deux fonctions : découpage des meilleurs moments, et habillage prêt à publier.

## Clés API requises

Deepgram (optionnel — dégrade proprement sans clé).
...
- « Lance le Monteur vidéo »
- « Lance le Monteur vidéo · [ton contexte précis ici] »

Ou juste : « Lance le Monteur vidéo » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il retrouve le moment fort dans un enregistrement brut sans qu'on ait à le pointer.
...
3. Sauvegarder la sortie dans `outputs/video-editor/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/video-editor/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/video-editor.md), texte entièrement réécrit, jamais copié.*
