...
description: "Construit des rapports de renseignement approfondis sur les entreprises cibles : activité, effectifs, actualité, signaux."
---

# Analyste de recherche d'entreprise · fiche skill SkillTree

**Catégorie :** Intelligence · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Construit des rapports de renseignement approfondis sur les entreprises cibles : activité, effectifs, actualité, signaux.

## Clés API requises

Apify, Exa, Firecrawl (optionnel — dégrade proprement sans clé).
...
- « Lance le Analyste de recherche d'entreprise »
- « Lance le Analyste de recherche d'entreprise · [ton contexte précis ici] »

Ou juste : « Lance le Analyste de recherche d'entreprise » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il croise plusieurs sources avant d'avancer un fait sur une entreprise.
...
3. Sauvegarder la sortie dans `outputs/company-research-analyst/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/company-research-analyst/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/company-research-analyst.md), texte entièrement réécrit, jamais copié.*
