---
name: delivery-status-reporter
description: "Informe les clients de l'avancement avant même qu'ils pensent à demander."
---

# Rapporteur de statut de livraison · fiche skill SkillTree

**Catégorie :** Opérations · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Informe les clients de l'avancement avant même qu'ils pensent à demander.

## Clés API requises

Resend (optionnel — dégrade proprement sans clé).
...
- « Lance le Rapporteur de statut de livraison »
- « Lance le Rapporteur de statut de livraison · [ton contexte précis ici] »

Ou juste : « Lance le Rapporteur de statut de livraison » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il préfère prévenir tôt plutôt que gérer une relance anxieuse.
...
3. Sauvegarder la sortie dans `outputs/delivery-status-reporter/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/delivery-status-reporter/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/delivery-status-reporter.md), texte entièrement réécrit, jamais copié.*
