---
name: social-prospecting-specialist
description: "Scrape les commentateurs des posts LinkedIn viraux, enrichit leurs profils, les note par rapport à ton ICP, et rédige des DM personnalisés pour les meilleurs matchs — le tout en un seul passage."
---

# Spécialiste de prospection sociale · fiche skill SkillTree

**Catégorie :** Ventes · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Scrape les commentateurs des posts LinkedIn viraux, enrichit leurs profils, les note par rapport à ton ICP, et rédige des DM personnalisés pour les meilleurs matchs — le tout en un seul passage.

## Clés API requises

Apify, Heyreach (optionnel — dégrade proprement sans clé).
...
- « Lance le Spécialiste de prospection sociale »
- « Lance le Spécialiste de prospection sociale · [ton contexte précis ici] »

Ou juste : « Lance le Spécialiste de prospection sociale » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il prospecte là où l'intérêt vient de se manifester, pas au hasard.
...
3. Sauvegarder la sortie dans `outputs/social-prospecting-specialist/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/social-prospecting-specialist/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/social-prospecting-specialist.md), texte entièrement réécrit, jamais copié.*
