...
description: "Transforme tes photos de référence en images de marque personnelle cohérentes et fidèles à ton identité, via un modèle de personnage cohérent."
---

# Designer de marque personnelle · fiche skill SkillTree

**Catégorie :** Marketing · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Transforme tes photos de référence en images de marque personnelle cohérentes et fidèles à ton identité, via un modèle de personnage cohérent.

## Clés API requises

Fal (optionnel — dégrade proprement sans clé).
...
- « Lance le Designer de marque personnelle »
- « Lance le Designer de marque personnelle · [ton contexte précis ici] »

Ou juste : « Lance le Designer de marque personnelle » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il garde ton identité visuelle reconnaissable d'une image à l'autre.
...
3. Sauvegarder la sortie dans `outputs/personal-brand-designer/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/personal-brand-designer/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/personal-brand-designer.md), texte entièrement réécrit, jamais copié.*
