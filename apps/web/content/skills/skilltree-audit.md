...
description: "La carte SkillTree recense chaque métier IA à déléguer dans une entreprise, réparti sur 7 départements. Tu peux marquer ton propre niveau de déploiement à la main — ou lancer cet audit et laisser un agent le calculer pour toi."
---

# Audit SkillTree · fiche skill SkillTree

**Catégorie :** Transverse · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

La carte SkillTree recense chaque métier IA à déléguer dans une entreprise, réparti sur 7 départements. Tu peux marquer ton propre niveau de déploiement à la main — ou lancer cet audit et laisser un agent le calculer pour toi.
...
- « Lance le Audit SkillTree »
- « Lance le Audit SkillTree · [ton contexte précis ici] »

Ou juste : « Lance le Audit SkillTree » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il calcule ton niveau réel de déploiement plutôt que de te demander de l'estimer à l'œil.
...
3. Sauvegarder la sortie dans `outputs/skilltree-audit/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/skilltree-audit/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/skilltree-audit.md), texte entièrement réécrit, jamais copié.*
