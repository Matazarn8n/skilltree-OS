...
description: "Capture la chose la plus coûteuse qu'une entreprise produit et jette généralement à la poubelle : comment le travail a vraiment été fait. Il remplit deux fonctions — documenter le process, et le rendre réutilisable par quelqu'un d'autre."
---

# Rédacteur de playbook · fiche skill SkillTree

**Catégorie :** Opérations · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Capture la chose la plus coûteuse qu'une entreprise produit et jette généralement à la poubelle : comment le travail a vraiment été fait. Il remplit deux fonctions — documenter le process, et le rendre réutilisable par quelqu'un d'autre.
...
- « Lance le Rédacteur de playbook »
- « Lance le Rédacteur de playbook · [ton contexte précis ici] »

Ou juste : « Lance le Rédacteur de playbook » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il documente ce qui a marché en pratique, pas ce qui devrait marcher en théorie.
...
3. Sauvegarder la sortie dans `outputs/playbook-writer/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/playbook-writer/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/playbook-writer.md), texte entièrement réécrit, jamais copié.*
