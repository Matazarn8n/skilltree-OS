...
description: "Transforme une réunion en boucle fermée. Donne-lui une transcription ou des notes : il en extrait chaque action avec un responsable, une échéance, et la citation exacte d'origine — puis sépare ce que TON camp a promis de ce que L'AUTRE camp a promis."
---

# Coordinateur de suivi · fiche skill SkillTree

**Catégorie :** Opérations · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Transforme une réunion en boucle fermée. Donne-lui une transcription ou des notes : il en extrait chaque action avec un responsable, une échéance, et la citation exacte d'origine — puis sépare ce que TON camp a promis de ce que L'AUTRE camp a promis.

## Clés API requises

Fireflies (optionnel — dégrade proprement sans clé).
...
- « Lance le Coordinateur de suivi »
- « Lance le Coordinateur de suivi · [ton contexte précis ici] »

Ou juste : « Lance le Coordinateur de suivi » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il ne laisse jamais une promesse d'appel se perdre dans les notes.
...
3. Sauvegarder la sortie dans `outputs/followup-coordinator/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/followup-coordinator/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/followup-coordinator.md), texte entièrement réécrit, jamais copié.*
