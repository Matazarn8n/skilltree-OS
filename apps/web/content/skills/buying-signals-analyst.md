...
description: "Surveille tes comptes cibles pour repérer les événements qui transforment une entreprise froide en entreprise chaude — recrutements en série, levées de fonds, changements de stack technique, mouvements de direction."
---

# Analyste de signaux d'achat · fiche skill SkillTree

**Catégorie :** Ventes · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Surveille tes comptes cibles pour repérer les événements qui transforment une entreprise froide en entreprise chaude — recrutements en série, levées de fonds, changements de stack technique, mouvements de direction.

## Clés API requises

Apify, Apollo, Exa (optionnel — dégrade proprement sans clé).
...
- « Lance le Analyste de signaux d'achat »
- « Lance le Analyste de signaux d'achat · [ton contexte précis ici] »

Ou juste : « Lance le Analyste de signaux d'achat » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il ne remonte que les signaux qui changent vraiment la probabilité d'achat, pas le bruit.
...
3. Sauvegarder la sortie dans `outputs/buying-signals-analyst/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/buying-signals-analyst/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/buying-signals-analyst.md), texte entièrement réécrit, jamais copié.*
