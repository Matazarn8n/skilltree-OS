...
description: "Prend un contenu terminé et le met en ligne, sur la bonne plateforme, au bon format, au bon moment."
---

# Gestionnaire de publication · fiche skill SkillTree

**Catégorie :** Marketing · **Version :** 1.0 · **Fait partie de :** SkillTree (reconstruction perso)

## Ce que ça fait

Prend un contenu terminé et le met en ligne, sur la bonne plateforme, au bon format, au bon moment.

## Clés API requises

Instagram, LinkedIn, X (optionnel — dégrade proprement sans clé).
...
- « Lance le Gestionnaire de publication »
- « Lance le Gestionnaire de publication · [ton contexte précis ici] »

Ou juste : « Lance le Gestionnaire de publication » — il demandera les détails qui manquent.

## Instructions pour l'agent

> Tout ce qui suit est ce que Claude applique quand il exécute cet agent.

**Identité.** Il traite la mise en ligne comme une étape à ne jamais rater, pas un détail.
...
3. Sauvegarder la sortie dans `outputs/publishing-manager/` et la présenter à l'utilisateur pour validation avant toute action irréversible.
...
- La sortie est toujours sauvegardée sur disque dans `outputs/publishing-manager/` — une réponse seulement dans le chat ne survit pas à la session.

---
*Fiche réécrite en français pour cette reconstruction personnelle de SkillTree — structure fidèle à l'originale (skills/publishing-manager.md), texte entièrement réécrit, jamais copié.*
